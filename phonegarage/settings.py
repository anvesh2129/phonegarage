"""
Django settings for phonegarage project.
...
WSGI_APPLICATION = 'phonegarage.wsgi.application'
...
STRIPE_PUBLISHABLE_KEY = 'pk_test_51M1zXKDbtPmOLMIufoHAWI524idMMxbQ6qlCzTCup1GcDiKbNIcknE2y5REtVgSiSF5dhQ7qtCmD7o05RStv2tlO00MibFndAR'
STRIPE_SECRET_KEY = 'sk_test_51M1zXKDbtPmOLMIuWZxM6MnfOUtrjs1wKhJDB2aYh4SFIBcqCIlAgdCCU7cu8DqYATraf2IUWnd5kjkKddOowTSm00N6ExAlPY' #these are stripe api keys used for production for launch we would have to get the life key as mentioned in the stripe documentations you get them after making an account
...
EMAIL_HOST_USER = 'postmaster@sandbox115823aa3ca446ce92a161fd86d78367.mailgun.org' #using mailgun sandbox as it is free after we create an free acount
EMAIL_HOST_PASSWORD = '9af454fec2f94f8a5d9d20b96374cd6c-f2340574-9236e110'